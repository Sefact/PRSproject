    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_one', models.ImageField(blank=True, null=True, upload_to='images/blog/%Y/%m/%d')),
                ('image_two', models.ImageField(blank=True, null=True, upload_to='images/blog/%Y/%m/%d')),
                ('image_three', models.ImageField(blank=True, null=True, upload_to='images/blog/%Y/%m/%d')),
                ('image_four', models.ImageField(blank=True, null=True, upload_to='images/blog/%Y/%m/%d')),
                ('image_five', models.ImageField(blank=True, null=True, upload_to='images/blog/%Y/%m/%d')),
