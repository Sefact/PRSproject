    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.TextField(max_length=200)),
                ('context', models.TextField(blank=True, max_length=500, null=True)),
                ('image_one', models.ImageField(blank=True, null=True, upload_to='images/tag/%Y/%m/%d')),
                ('image_two', models.ImageField(blank=True, null=True, upload_to='images/tag/%Y/%m/%d')),
                ('image_three', models.ImageField(blank=True, null=True, upload_to='images/tag/%Y/%m/%d')),
                ('image_four', models.ImageField(blank=True, null=True, upload_to='images/tag/%Y/%m/%d')),
                ('image_five', models.ImageField(blank=True, null=True, upload_to='images/tag/%Y/%m/%d')),
